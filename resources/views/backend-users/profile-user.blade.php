            ...
            <div class="card mb-5" style="max-width: 100%;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        ...
                        <a class="ิbtn btn-outline-danger " href="{{ route('users.edit') }}"><i class="fas fa-edit">แก้ไขข้อมูลส่วนตัว</i></a>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <label class="topic-gray" style="margin-left: 5%">ที่อยู่:  </label> <label class="topic-black"> {{ $data->address }}</label>
                            <br>
