            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        วันเริ่ม : <input type="text" name="start_date" id="start_date" value="{{ array_get($about,'0.start_date') }}">
                        วันสิ้นสุด : <input type="text" name="end_date" id="end_date" value="{{ array_get($about,'0.end_date') }}">
                    </div>
